...
int main(int argc, char** argv){
  ...
  M._u(2) = 0; //v_0  = 0
  M._u(3) = 0; //v'_0 = 0
  M._nbd[0] = 2;   M._nbd[1] = 2; //both lower and upper bounds
  M._nbd[2] = 2;   M._nbd[3] = 2; //both lower and upper bounds
  ...
  M._u(4*N+1) = 0; 
  M._u(4*N  ) = 0; 
  M._nbd[4*N+3] = 2;   M._nbd[4*N+2] = 2; //both lower and upper bounds
  M._nbd[4*N+1] = 2;   M._nbd[4*N  ] = 2; //both lower and upper bounds
