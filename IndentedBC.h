...
class IndentedBC: public Problem {
public:
  double _alpha; //angle 
...
>>>>>>> Stashed changes
    ...
    _u0 = para(6); //_d - _rho*cos(_alpha)-1; //1, here represents the radius of the cylinder
    _v0 = para(7); //_rho*sin(_alpha);
    
    vs = new Indented(xvs, para, nodes, conn);
